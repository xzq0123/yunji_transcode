...
AX_S32 SAMPLE_FillCanvas(AX_IVPS_RGN_CANVAS_INFO_T *ptCanvas)
{
    ...
    AXCL_IVPS_DrawLine(ptCanvas, tAttr, tLine, 2);
    ...
    tPolygon[3].nX = 110;
    tPolygon[3].nY = 380;
    AXCL_IVPS_DrawPolygon(ptCanvas, tAttr, tPolygon, 4);
    ...
    tRect.nW = 100;
    tRect.nH = 50;
    AXCL_IVPS_DrawRect(ptCanvas, tAttr, tRect);
    ...
    tFoldLine[2].nX = 300;
    tFoldLine[2].nY = 250;
    AXCL_IVPS_DrawLine(ptCanvas, tAttr, tFoldLine, 3);
    ...
    AXCL_IVPS_DrawLine(ptCanvas, tAttr, CornerRect, 3);
...
AX_S32 SAMPLE_DrawCover(const AX_VIDEO_FRAME_T *pstVFrame, const SAMPLE_IVPS_COVER_T *ptIvpsCover, char *strFilePath, char *pCaseId)
{
    ...
    AXCL_IVPS_DrawLine(&tCanvas, tAttr, tPoint, 4);
    ...
    AXCL_IVPS_DrawPolygon(&tCanvas, tAttr, tPoint, 4);
    ...
    AXCL_IVPS_DrawRect(&tCanvas, tAttr, tRect);
