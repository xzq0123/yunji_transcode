...
public:
    ...
    AX_U32 GetRectWidth(AX_VOID) const;
    AX_U32 GetRectHeight(AX_VOID) const;

    AX_U32 GetPriPoolID(AX_U32 nID) const;
...
protected:
    ...
    AX_BOOL CreatePrivatePool(AX_U32 u32BlkCnt, AX_U64 u64BlkSize, AX_U64 u64MetaSize);
...
protected:
    ...
    AX_U32 m_priPoolID[MAX_VD_CHN];
    AX_U32 m_rectWidth{0};
    AX_U32 m_rectHeight{0};
...
inline AX_U32 CVo::GetPriPoolID(AX_U32 nID) const {
    return m_priPoolID[nID];
}

inline AX_U32 CVo::GetRectWidth(AX_VOID) const {
    return m_rectWidth;
}

inline AX_U32 CVo::GetRectHeight(AX_VOID) const {
    return m_rectHeight;
}
