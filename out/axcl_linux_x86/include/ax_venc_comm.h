...
typedef struct axJPEG_ENCODE_ONCE_PARAMS_T
{
    ...
    /* for thumbnail */
    AX_BOOL bThumbEnable;  /* AX_FALSE: disable thumbnail encode; AX_TURE: enable thumbnail encode. */
    AX_U32 u32ThumbWidth;  /* thumbnail width */
    AX_U32 u32ThumbHeight; /* thumbnail height */
